...
import io.github.zap.zombies.game.mob.goal.OptimizedArrowAttack;
...
@MythicAIGoal(name = "unboundedArrowAttack")
public class WrappedMythicArrowAttack extends Pathfinder {

    private final OptimizedArrowAttack optimizedBowAttack;

    public WrappedMythicArrowAttack(AbstractEntity entity, String line, MythicLineConfig mlc) {
        super(entity, line, mlc);

        if (entity.getBukkitEntity() instanceof Mob mob) {
            this.optimizedBowAttack = new OptimizedArrowAttack(mob, new AttributeValue[0],
